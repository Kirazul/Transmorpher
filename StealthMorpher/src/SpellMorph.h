...
// Reverse lookup: a spell id whose SpellVisual (v0 or v1) == visualId, or 0 if none.
// Lets the Visuals tab resolve a name + icon for a visual via GetSpellInfo(spellId).
